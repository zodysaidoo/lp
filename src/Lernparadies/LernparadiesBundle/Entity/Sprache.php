...
class Sprache
{
     ...
     * Set spracheNewdate
     *
     * @param \DateTime $spracheNewdate
     * @return Sprache
     */
    public function setSpracheNewdate($spracheNewdate)
    {
        $this->spracheNewdate = $spracheNewdate;
     ...
     * Set spracheEditdate
     *
     * @param \DateTime $spracheEditdate
     * @return Sprache
     */
    public function setSpracheEditdate($spracheEditdate)
    {
        $this->spracheEditdate = $spracheEditdate;
